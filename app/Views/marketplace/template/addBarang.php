                        ...
                        <div class="row">
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputText" aria-describedby="textHelp" placeholder="Nama Barang">
                                    <small id="textHelp" class="form-text text-muted">Masukkan Nama Barang</small>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Harga Barang</label>
                                    <input type="number" class="form-control" id="exampleInputHarga" aria-describedby="numberHelp" placeholder="Harga Barang">
                                    <small id="numberHelp" class="form-text text-muted">Masukkan Harga Barang</small>
                                </div>
