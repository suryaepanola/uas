                    ...
                    <article>
                        ...
                        <div class="row">
                            ...
                            <div class="card mb-3 mx-3" style="width: 18rem;">
                                <img class="card-img-top mt-3" src="<?=base_url('/assets/img')."/".$toko['baju_gambar']?>" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title"><?= $toko['baju_title'] ?></h5>
                                    <p class="card-text">Rp.<?= $toko['baju_harga'] ?></p>
                                    <p class="card-text font-family-arial" >Stok : <?= $toko['baju_stok'] ?></p>
                                    <a href="#" class="btn btn-secondary ml-10" style="width :15rem;margin-right :5rem; " >Beli</a>
                                </div>
                            </div>
                            <?php } ?>
                        </div>
